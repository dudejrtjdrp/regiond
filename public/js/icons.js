...
(function (global) {
  ...
  var DRAW = {
    ...
    /* ★ §19-F1(F08-3) — 서리탑·화염탑. 화살탑과 같은 뼈대에 얼음 결정과 불꽃만 갈아 끼운다. */
    frostTower: function (P) {
      P(5, 7, 6, 8, '#5d84a6'); P(5, 7, 6, 1, '#7ba3c4');
      P(3, 3, 10, 4, '#a9c6d8'); P(3, 3, 10, 1, '#dff1fb');
      P(7, 0, 2, 6, '#dff1fb'); P(4, 1, 8, 2, '#9fd4ee');
    },
    flameTower: function (P) {
      P(2, 11, 12, 4, '#7d2a2c'); P(2, 11, 12, 1, '#b06a44');
      P(4, 5, 8, 6, '#b06a44'); P(4, 5, 8, 1, '#d08a5c');
      P(6, 1, 4, 5, '#e08541'); P(7, 0, 2, 3, '#f6cf7a');
    },
    ballista: function (P) {
