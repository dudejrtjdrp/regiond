...
(function (global) {
  ...
  var TIERS = [
    { tier: 0, name: '야영지', radius: 9, requires: {},
    ...
    { tier: 1, name: '개척촌', radius: 12, requires: { structures: { hut: 1 }, resources: { grain: 20 } },
      ...
      line: '굴뚝이 하나 늘었다.' },
    { tier: 2, name: '촌락', radius: 17, requires: { population: 5 },
    ...
    { tier: 3, name: '마을', radius: 24, requires: { population: 12 },
  ...
  var CHAPTERS = [
    { id: 1, key: 'spark', name: '불씨', subtitle: '마차가 멈춘 자리',
      ...
      steps: [
        ...
        { key: 'wood10', short: '천막', title: '천막을 지을 목재 10을 모으세요',
      ...
      reward: { line: '모닥불이 제대로 타오른다.',
                card: { icon: 'hammer', title: '배치대가 열렸습니다', text: '이제 [건설]로 천막 자리를 잡을 수 있습니다.' } } },
    { id: 2, key: 'first_roof', name: '첫 지붕', subtitle: '비를 피할 자리',
      ...
      steps: [{ key: 'tent_built', title: '모닥불 곁에 천막을 세우세요', verb: 'E — 짓기',
                sub: '[건설]에서 천막을 고르고 땅을 누른 뒤, 현장 곁에서 E 를 눌러 지어 올립니다.',
                ...
                hint: { sel: '#tb-build', text: '여기서 지을 것을 고르고 땅을 눌러 자리를 잡습니다' } }],
  ...
  function baseConfig() {
    return {
      ...
      tiers: { speedBonusPerTier: 0.05, maxDefinedTier: 6, levels: TIERS,
               endless: { populationStep: 30, radiusPerTier: 3, namePattern: '왕도 {n}대' } },
      skills: {
